        ...
        <?php } else { ?> 
            <div class="row m150t m150b">
                <div class="col-md-6">
                    ...
                    the_post_thumbnail(); 
                    ?>
                    <div class="t-secondary m10t"><?=get_post(get_post_thumbnail_id())->post_title; ?></div>
                </div>
                <div class="col-md-6">
                    <div class="entry-content t-secondary">
                         <div class="entry-header t-secondary">
                            <!-- <h1 class="entry-title"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h1> -->

                            <?php if ('post' == get_post_type()) { ?> 
                            <div class="entry-meta t-secondary">
                                <?php $Bsb4Design->postOn(); ?> 
                            </div><!-- .entry-meta -->
                            <?php } //endif; ?> 
                        </div><!-- .entry-header -->
                        
                        <div class="post-title m20b"><h2 class="t-secondary"><?=get_the_title();?></h2></div>
                        ...
                        <div class="m30t">
                            <a href="/news" class="t-secondary t-sanserif no-link-decoration"><h5><span class="t-underline">more news stories</span><h5></a>
                        </div>
                    </div>
                </div>
            </div>
